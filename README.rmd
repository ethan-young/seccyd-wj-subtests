---
title: "How does adversity relate to performance across different abilities in the same person?"
...
This repository contains a preregistration, data, code, an (eventual) reproducible manuscript/supplement for a project entitled "How does adversity relate to performance across different abilities in the same person?" (working title).
...
3.  [`manuscript`](manuscript/`): a manuscript written in Quarto for submission to a journal.
