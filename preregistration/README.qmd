...
**H2:** Compared with overall WJ scores, the effect of harshness and/or unpredictability will vary; some sub-tests will show lowered performance, whereas others will remain ‘intact’ (i.e., should little if any change).
...
This measure is based on @belsky2012 includes three variables that are standardized and averaged together over the relevant time period:
...
This measure is based on @li2018 computes the residual variance in income-to-needs ratios after a linear trend is fit to each participant. 
