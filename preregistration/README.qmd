...
We might break apart composites. For exampe, we may analyze Census variables separately or items from the classic unpredictaiblity measure. If we do so, these analyses will be reported in a supplement, only. We may mention them in the main text, but they will not be interpreted to the same degree as the main analyses.
