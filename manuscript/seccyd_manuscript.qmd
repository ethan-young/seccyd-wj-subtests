...
To resolve this issue, we conducted a set of secondary analyses that use different methods for computing variability. We report analyses using income-to-needs varaibility scores and income-to-needs average percent change scores (see Secondary Analyses).
