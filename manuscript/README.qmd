...
that work to cancel out general or specific performance reductions. <!-- This paragraph and the one above it need more work. I've rewritten in an attempt to make it more clear, but I still think the edited version is too complicated. Perhaps we can chat about how to phrase it more clearly early next week.-->

Our secondary analyses provided insights about measuring socioeconomical variability
...
income tend to experience higher variance in income. We found that
...
attention to appropriate validation procedures to verify that such scores
...
Our goal was to work towards constructing a "high resolution" map of the skills and
