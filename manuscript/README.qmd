...
Although we simulated adversity scores, we used the actual WJ test
scores from the SECCYD data used in this study. Simulations showed that,
...
association between adversity and overall WJ performance (e.g.,
within-person average of all subtests; see Figure 1). Interaction terms
...
specific hypothesis), we do not correct for multiple testing. Instead,
...
disadvantage and performance on Passage Completion, Calculations, Verbal
...
equivalent to the main effect. The association between disadvantage and
...
subtest were also varied. Associations between socioeconomic
disadvantage and subtest performance on Passage Completion,
Calculations, Letter-Word, and Short-Term Memory did not statistically
differ from the overall main effect (see Figure 3). However,
neighborhood socioeconomic disadvantage and subtest performance
associations for the Picture Vocabulary, Verbal Analogies, and Applied
Problems subtests were significantly more negative than the main effect
...
performance was reduced. However, Picture Vocabulary and Verbal Analogy
subtests performance was particularly reduced. However, across both
...
Simple effects indicated that exposure to family transitions was not
...
In this paper, we set out to document adversity related cognitive
performance profiles. We used a principled exploration approach to
...
Overall, we found that, although indicators of harshness (family income
and neighborhood socioeconomic disadvantage) seemed to reduce
performance on most WJ subtests, Auditory Processing and Auditory-Visual
Associations remained intact and relatively enhanced compared to overall
WJ performance. In contrast, exposure to indicators of unpredictability
...
performance on traditional achievement tests. Achievement and cognitive
...
harsh/unpredictable conditions. Yet, for family income and neighborhood
...
Second, our harshness analyses demonstrate co-occuring reductions,
relative enhancements, and intact performance patterns within the same
individual. Specifically, overall performance was reduced, with tests of
reading, math, reasoning, and short term memory underpinning this
general pattern. However, tests of verbal and crystallized knowledge
(i.e., Picture Vocabulary and Verbal analogies) were significantly more
reduced. Despite the overall WJ performance patter, Auditory Processing
...
with the notion adversity exposure can be associated with nuanced
...
co-occurring and within-person data patterns across many skills.
...
on examining the skills and abilities of disadvantaged populations
...
We did not find any instance of "pure" enhancement, or cases where
subtest performance was significanlty (and practically) positive as a
function of adversity exposure. Instead, we found patterns of relative
enhancement (less-reduced) and intact performance. However, what is
intact, relative enhancement, and "less-reduced" performance and what
are their differences? Although our inferential criteria help
distinguish data patterns, they cannot tease apart the processes that
produce them. In the current study, for example, if Auditory Processing
and Auditory-Visual Associations performance is truly enhanced income
disadvantage, one explanation might be that socioeconomic disadvantage
reduces general cogntive skills shared across all subtests, perhaps
through a general mechanism. However, this reducing effect co-occurs
with specific enhanced auditory skills unique to these subtests, which
is adaptive value in socioeconomically harsh conditions. But, combined
with reduced general cognitive performance, this enhancement does not
fully counteract the overall performance reduction.

In contrast, Auditory Processing and Auditory-Visual Associations could
remain intact *despite* exposure to family income disadvantage. The
forces reducing performance on other subtests leave auditory skills
untouched. In this case, such skills might not have special adaptive
value or relevance for functioning in high socioeconomic disadvantage,
but also do impose a cost. Thus, performance is equal to
socioeconomically advantaged peers. Another possibility is that
adversity exposure leads individuals to adopt compensatory strategies
that work to cancel out general or specific performance reductions.
