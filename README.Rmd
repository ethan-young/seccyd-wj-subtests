...
4.  [`preregistration/`](preregistration/README.md): a preregistration document based on [@akker2021] that details my plans for this project.
5.  [`scripts/`](scripts/README.md): R-scripts that read, analyze, and produce all outputs.
